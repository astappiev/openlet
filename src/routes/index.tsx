...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      ...
      {
        property: "og:title",
        content: "Openlet | Free flashcards & study tools",
      },
      {
  ...
  [
    {
      ...
      icon: Layers,
      title: "Flashcards",
      blurb: "Review terms your way",
    },
    {
      id: "learn",
      icon: GraduationCap,
      title: "Learn",
      blurb: "Spaced repetition",
    },
      ...
      <Shell className="grid items-center gap-12 py-14 md:gap-16 md:py-20 lg:grid-cols-2 lg:py-24">
        <div>
          ...
          <p
            ...
            style={{ color: MUTED }}
          >
            Master anything with free flashcards, practice tests, and study
            modes. No ads, no upgrade wall.
          </p>
      ...
      <Shell>
        <div className="max-w-2xl">
          ...
          <p
            ...
            style={{ color: MUTED }}
          >
            Five study modes. Nothing locked. Switch tabs and try each one on a
            short biology set.
          </p>
        </div>
            ...
            return (
              <button
                ...
                style={{
                  ...
                  boxShadow: active
                    ? "0 8px 24px -8px rgba(66,85,255,0.45)"
                    : "none",
                }}
              >
                <m.icon
...
function DemoFlashcards() {
  ...
  return (
    <div className="mx-auto max-w-md">
      <div
        className="mb-3 flex justify-between text-xs font-semibold"
        style={{ color: MUTED }}
      >
