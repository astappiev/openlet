...
const variants: Record<ButtonVariant, string> = {
  primary:
    "bg-[#4255ff] text-white hover:bg-[#3b4ce0] shadow-sm disabled:opacity-50",
  secondary:
    "bg-[#eef0ff] text-[#2a35b8] hover:bg-[#e0e4ff] disabled:opacity-50",
  outline:
    "border border-[#e8eaf0] bg-white text-[#1a1d26] hover:bg-[#f6f7fb] disabled:opacity-50",
  ghost:
    "text-[#4a5065] hover:bg-[#f6f7fb] hover:text-[#1a1d26] disabled:opacity-50",
  danger:
    "border border-[#fecaca] bg-white text-[#e11d48] hover:bg-[#fef2f2] disabled:opacity-50",
};
